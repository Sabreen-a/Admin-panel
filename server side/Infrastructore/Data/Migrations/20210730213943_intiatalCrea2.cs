...
{
    public partial class intiatalCrea2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Qount = table.Column<double>(type: "float", nullable: false),
                    priceBuy_one = table.Column<double>(type: "float", nullable: false),
                    priceBuyOrgnal_all = table.Column<double>(type: "float", nullable: false),
                    price_Sall_one = table.Column<double>(type: "float", nullable: false),
                    price_Sall_all = table.Column<double>(type: "float", nullable: false),
                    earn_Money = table.Column<double>(type: "float", nullable: false),
                    Date_attach = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Date_Experied = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_productypes_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "productypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
